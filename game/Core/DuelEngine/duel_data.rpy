init python:
    ...
    actions_lib = {'clinch': {'name': __('clinch'), 'rarity': 'common', 'power': 0, 'special_effect': clinch_special},
                    ...
                    'move': {'name': __('move'), 'rarity': 'common', 'power': 2, 'use_weapon': True, 'mighty': False, 'slot': 'maneuver', 'special_effect': None},
                    'rebound': {'name': __('rebound'), 'rarity': 'common', 'power': 3, 'use_weapon': True, 'mighty': False, 'slot':  'fortitude', 'special_effect': None},
