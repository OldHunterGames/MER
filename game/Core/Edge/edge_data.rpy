init -10 python:
    ...
    edge_option_cards = {'feed_hungry': {'name': 'Feed the hungry', 'description': __('Good deed. Cost you 5/bars.'), 'label': 'lbl_edge_feed_hungry', 'image': 'images/miscards/card.png', }, 
        ...
        'fi_intimidate': {'name': 'Intimidate', 'description': __('Ardent deed. Opposed willpower check to succed. Get "Charriot" relations arcane.'), 'label': 'lbl_first_impression_intimidate', 'image': 'images/miscards/card.png', }, 
        'fi_getknow': {'name': 'Get to know', 'description': __('Lawful deed. Opposed wisdom check to succed. Get "Justuce" relations arcane.'), 'label': 'lbl_first_impression_getknow', 'image': 'images/miscards/card.png', }, 
        'fi_flatter': {'name': 'Flatter', 'description': __('Good deed. Opposed finesse check to succed. Get "Lovers" relations arcane.'), 'label': 'lbl_first_impression_flatter', 'image': 'images/miscards/card.png', }, 
        'fi_joke': {'name': 'Jock', 'description': __('Chaotic deed. Unpredictible outcome.'), 'label': 'lbl_first_impression_joke', 'image': 'images/miscards/card.png', }, 
        'fi_mock': {'name': 'Mock', 'description': __('Evil deed. Gain "Moon" relations arcane and self-affirm your authority.'), 'label': 'lbl_first_impression_mock', 'image': 'images/miscards/card.png', }, 
        'fi_reticence': {'name': 'Reticence', 'description': __('Timid deed. Be patient and quiet. No risk. No reward.'), 'label': 'lbl_first_impression_reticence', 'image': 'images/miscards/card.png', }, 
