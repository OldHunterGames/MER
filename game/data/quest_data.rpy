init python:
    ...
    quests_data = {
        ...
        'edge_bond_quest':{'name': __("Rome: path of the slave"), 'description': __("Major Houses hire valuable employees on terms slightly better than slavish. It's not a bad way to get into Eternal Rome and get a stable job, but you need to prove yourself  worthy to the recruiter of the Major House.")}, 
        'edge_citisen_quest':{'name': __("Rome: path of the slave"), 'description': __("Only a select few begin their lives in Eternal Rome as full-fledged citizens. To receive this honorary status, it is necessary to show the recruiter of the Major House that by acting independently you will bring more benefit than doing bonded labor.")}, 
