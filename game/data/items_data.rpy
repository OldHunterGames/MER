init python:
    ...
    weapon_data = {
        'bare_hands': {'name': __('bare hands'), 'size': 'twohand', 'damage_type': 'subdual', 'quality': 0, 'price': -1},         
