init python:
    weapon_data = {
        ...
        'quarterstaff': {'name': __('quarterstaff'),'size': 'twohanded', 'damage_type': 'subdual', 'quality': 3},
        ...
        'hunting_weapon': {'name': __('hunting weapon'),'size': 'twohanded', 'damage_type': 'piercing', 'quality': 2},
        'pickaxe': {'name': __('pickaxe'),'size': 'twohanded', 'damage_type': 'piercing', 'quality': 2},
        'strudy_axe':{'name': __('strudy axe'),'size': 'twohanded', 'damage_type': 'slashing', 'quality': 2},
        'rusty_axe':{'name': __('rusty axe'),'size': 'twohanded', 'damage_type': 'slashing', 'quality': 1},
    ...
    armor_data = {
        'hard_armor': {'name': __('hard armor'), 'protection_type': 'heavy', 'quality': 3},
        'soft_armor': {'name': __('soft armor'), 'protection_type': 'light', 'quality': 3},            
        'leather_coat': {'name': __('soft armor'), 'protection_type': 'light', 'quality': 2},  
        'bad_plate': {'name': __('bad plate'), 'protection_type': 'heavy', 'quality': 1},
            }
